...
<head>
    ...
    {{-- 1. MUAT SKRIP UTAMA CDN TERLEBIH DAHULU --}}
    <script src="https://cdn.tailwindcss.com"></script>

    {{-- 2. BARU JALANKAN KONFIGURASINYA --}}
    <script>
        tailwind.config = { darkMode: 'class' }
    </script>

    {{-- 3. Skrip inisialisasi tema kita (ini sudah benar) --}}
    <script>
...
<div class="min-h-screen flex flex-col items-center justify-center text-center px-4">
    <h1 class="text-4xl font-bold text-gray-800 dark:text-gray-200">Maaf, Sedang Ada Gangguan</h1>
    <p class="mt-4 text-lg text-gray-600 dark:text-gray-400">Saat ini kami sedang mengalami kendala teknis pada layanan database kami.</p>
    <p class="mt-2 text-gray-500 dark:text-gray-300">Silakan coba lagi dalam beberapa saat.</p>
</div>
